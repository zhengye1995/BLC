...
class CascadeSemanticRCNN(BaseDetector, RPNTestMixin):
    ...
    def __init__(self,
        ...
        super(CascadeSemanticRCNN, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(CascadeSemanticRCNN, self).init_weights(pretrained)
    ...
    def show_result(self, data, result, **kwargs):
        ...
        super(CascadeSemanticRCNN, self).show_result(data, result, **kwargs)
