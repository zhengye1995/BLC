...
# dataset settings
# dataset_type = 'CocoDatasetSeen65'
...
data = dict(
    ...
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/instances_val2014_seen.json',
...
log_level = 'INFO'
work_dir = './work_dirs/cascade_semantic_rcnn_r50_fpn_65_15_semantic_flow_learnable_bg_1x'
load_from = None
resume_from = None
workflow = [('train', 1)]
